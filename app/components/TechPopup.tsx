    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm">
      ...
      >
        ...
        <button
          ...
          className="absolute top-4 right-4 text-gray-400 transition-colors duration-200 z-10"
        >
          <svg
            className="w-6 h-6"
            fill="none"
        ...
        <div className="relative z-10 text-center">
          ...
          <p className="mb-6 text-gray-300 leading-relaxed">
            Join thousands of innovators building tomorrow&#39;s technology. Get
          ...
          <div className="space-y-3">
            <button
              onClick={() => setShowPopup(false)}
              className="w-full px-6 py-3 bg-gradient-to-r from-cyan-500 to-purple-600 text-white font-semibold rounded-xl transform transition-all duration-200 shadow-lg"
            >
              Get Early Access
            </button>
            ...
            <button
              onClick={() => setShowPopup(false)}
              className="w-full px-6 py-2 text-gray-400 transition-colors duration-200 text-sm"
            >
              Maybe later
            </button>
          </div>
        ...
        <div className='absolute inset-0 bg-[url("")] rounded-2xl'></div>
      </div>
    </div>
  );
}
